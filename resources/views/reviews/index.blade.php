    ...
    <div class="rounded-circle shadow-sm mb-2">
        <div class="bg-dark rounded p-2 row align-items-center">
            ...
            <div class="col-1 align-content-end">
                <button type="button" class="btn btn-primary " onclick="create();" data-toggle="tooltip" data-placement="bottom" title="Create A New Review" >
            ...
            <div>
                <div class="row align-items-center">
                    ...
                    <script>
                        let submit = function()
                        {
                            return confirm('Do you want to delete this review?');
                        };
                    </script>
                    <form onsubmit="submit();" action="/reviews/{{ $review->id }}" method="POST" class="col-2"  >
                        @csrf
                        @method('DELETE')
